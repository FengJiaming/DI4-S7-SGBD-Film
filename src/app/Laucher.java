...
public class Laucher {
	...
	private static void init() {
		...
		scenectrl.insertScene("La première fois qu'ils se sont rencontrés", 2, 2, listSetup);
		...
		scenectrl1.insertScene("La deuxième fois qu'ils se sont rencontrés", 1, 1, listSetup2);
